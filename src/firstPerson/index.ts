...
export class FirstPerson {
  ...
  private static readonly _DEFAULT_FIRSTPERSON_ONLY_LAYER = 0x00000009;
  ...
  private static readonly _DEFAULT_THIRDPERSON_ONLY_LAYER = 0x00000010;

  private static readonly _DEFAULT_BOTH_LAYER = 0x00000011;
  ...
  constructor(
    ...
    firstPersonBoneOffset: BABYLON.Vector3,
   ...
   */
  public setup({
    firstPersonOnlyLayer = FirstPerson._DEFAULT_FIRSTPERSON_ONLY_LAYER,
    thirdPersonOnlyLayer = FirstPerson._DEFAULT_THIRDPERSON_ONLY_LAYER,
  } = {}): void {
  ...
  private _createHeadlessModelForSkinnedMesh(parent: BABYLON.TransformNode, mesh: BABYLON.Mesh): void {
    ...
    if (!eraseBoneIndexes.length) {
      ...
      // TODO: check the value is correct (visible in both camare layer)
