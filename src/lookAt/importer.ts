...
export class LookAtImporter {
   ...
   */
  public import(loader: GLTFLoader, firstPerson: FirstPerson, expressionProxy: ExpressionProxy, humanoid: Humanoid): LookAtHead | null {
  ...
  protected _importApplyer(schemaFirstPerson: VRMSchema.FirstPerson, expressionProxy: ExpressionProxy, humanoid: Humanoid): LookAtApplyer | null {
  ...
  private _importCurveMapperBone(map: VRMSchema.FirstPersonDegreeMap): CurveMapper {
    return new CurveMapper(typeof map.xRange === 'number' ? DEG2RAD * map.xRange : undefined, typeof map.yRange === 'number' ? DEG2RAD * map.yRange : undefined, map.curve)
  }
